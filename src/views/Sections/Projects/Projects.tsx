...
export default function Projects() {
  ...
  const projectsSectionStyle =
    'w-full h-fit flex flex-col bg-white border-b-4 border-black md:pt-25 pt-15 pb-25 md:px-15 px-5 md:gap-25 gap-12 dot-bg';
  const projectsTitleStyle = 'md:text-8xl text-4xl text-black font-bold font-display text-center md:text-left';
