const callToActionContainerStyle =
  'md:h-[82vh] h-fit flex flex-col gap-20 items-center bg-black text-white md:pb-30 md:pt-30 pb-28 pt-22 px-5';
...
const buttonContainerStyle = 'flex md:flex-row flex-col md:gap-15 gap-10 w-full md:w-auto';
